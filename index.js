...
const start = () => {
    ...
    Это бот семьи "MARINAD"`);
        ...
        if (text === '/info') {
            return bot.sendMessage(chatId, `Сейчас я расскажу тебе о нашем заведении. Мы работаем в лучших семейных традициях, воспитанных в течение полувека. Эти традиции касаются мариновки и приготовления мясной продукции.`)
        }
        if (text === '/game') {
